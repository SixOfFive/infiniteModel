...
VERSION = "0.2-m4c184"  # version tag only; full changelog -> CHANGELOG.md
...
state.bind(shard_build, shard_forward, worker_load, worker_net, worker_hw)
